<nav class="p-2 flex items-center text-dark bg-gray-200 dark:text-white dark:bg-gray-800">
  ...
  @if (Auth::check())
  <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="text-dark hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:text-white dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
